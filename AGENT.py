...
║                                                                            ║
║  ⚠️  PERHATIAN UNTUK SEMUA MODEL AI  ⚠️                                   ║
║  Baca AGENT.md SEBELUM mengubah kode apa pun di proyek ini.              ║
║  AGENT.md berisi aturan WAJIB: workflow dev, CI/CD GitHub,               ║
║  alignment analysis backend/frontend/DB/logic/UI, dan retest cycle.      ║
║  Setiap perubahan WAJIB: localhost test → push → auto-test →            ║
║  analisis jika gagal → retest sampai lolos.                               ║
║                                                                            ║
...
📖 AI AGENTS: Baca AGENT.md untuk aturan development yang WAJIB dipatuhi.
